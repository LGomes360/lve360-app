  ...
  return [
    {
      ...
      content: [
        ...
        "The observation must state recorded facts neutrally and in second person.",
        ...
        "For keep, recommend repeating the current version without changing it. For shrink, test a smaller or easier version. For swap, test a different practice. For pause, test taking a break. For advance, test a very small increase.",
