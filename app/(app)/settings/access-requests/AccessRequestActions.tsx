...
type RequestStatus = "pending" | "waitlisted" | "declined" | "approved" | "revoked";
...
export function AccessRequestActions({
  ...
  const canTriage = status === "pending" || status === "waitlisted" || status === "declined" || status === "revoked";

  async function save(nextStatus: "pending" | "waitlisted" | "declined") {
    setSaving(true);
    setMessage("");
